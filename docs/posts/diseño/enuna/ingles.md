...
type: diseño
title: en una - digital publication
description: branding and motion graphics project for a digital music magazine
portada: portada.png
date: 2023-09-06
handle: kaste
---

![project header](header.gif)
![brand concept explained](explainer.gif)
![presentation divider](marquee.gif)
![icon presentation](iconography.gif)
![identity assets for social media](identity.gif)
![presentation break](break.png)
![branding project credits](credits.png)
