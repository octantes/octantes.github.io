...
type: diseño
title: cruzar - crypto cordillera
description: branding and motion graphics project for a datacenter service across the mountain range
portada: portada.png
date: 2024-09-19
handle: kaste
---
...
![brand fundamentals](fundamentos.gif)
![datacenter locations](topografico.gif)
![service packages](servicios.gif)
![presentation footer](footer.gif)
