...
.cta { 
  ...
  /* FONT   */ font-size: 0.8vw; font-style: italic;
  /* FILL   */ color: var(--humo);
...
.textbox { 
  ...
  /* CURSOR */ cursor: text;
  /* LAYOUT */ text-align: center;
  /* BOX    */ width: 15rem; padding: 0.5rem 1rem;
...
.submit { 
  ...
  /* BOX    */ width: 5rem; padding: 0.5rem 4rem;
  /* FILL   */ background-color: var(--lirio); color: var(--carbon);
  /* BORDER */ border: none; border-radius: var(--radius-ss);
  /* FONT   */ font-family: var(--font-main); font-style: italic; font-size: .9rem;
  /* MOTION */ transition: all var(--animate-fast);
